...
//   private final SideDependentList<YoVariable> ffAnklePitch = new SideDependentList<YoVariable>(ff_left_ankle_pitch, ff_right_ankle_pitch);
   ...
   private StateMachine<States, FinishableState> leftStateMachine, rightStateMachine;
   private SideDependentList<StateMachine<States, FinishableState>> stateMachines;
   ...
   private void setupStateMachines()
   {
      ...
      FinishableStateMachineFactory<States, FinishableState> leftFactory = new FinishableStateMachineFactory<>(States.class);
      FinishableStateMachineFactory<States, FinishableState> rightFactory = new FinishableStateMachineFactory<>(States.class);
      ...
      leftFactory.addFinishableState(States.SUPPORT, new SupportState(RobotSide.LEFT), States.TOE_OFF);
      leftFactory.addFinishableState(States.TOE_OFF, new ToeOffState(RobotSide.LEFT), States.SWING);
      leftFactory.addFinishableState(States.SWING, new SwingState(RobotSide.LEFT), States.STRAIGHTEN);
      leftFactory.addFinishableState(States.STRAIGHTEN, new StraightenState(RobotSide.LEFT), States.SUPPORT);

      // right State Transitions:
      rightFactory.addFinishableState(States.SUPPORT, new SupportState(RobotSide.RIGHT), States.TOE_OFF);
      rightFactory.addFinishableState(States.TOE_OFF, new ToeOffState(RobotSide.RIGHT), States.SWING);
      rightFactory.addFinishableState(States.SWING, new SwingState(RobotSide.RIGHT), States.STRAIGHTEN);
      rightFactory.addFinishableState(States.STRAIGHTEN, new StraightenState(RobotSide.RIGHT), States.SUPPORT);
   ...
   private class SupportState implements FinishableState
   {
   ...
   private class ToeOffState implements FinishableState
   {
      protected RobotSide robotSide;
      protected double minusForRightSide = 1.0;
   ...
   private class SwingState implements FinishableState
   {
   ...
   private class StraightenState implements FinishableState
   {
      private final RobotSide robotSide;
      protected double minusForRightSide = 1.0;
