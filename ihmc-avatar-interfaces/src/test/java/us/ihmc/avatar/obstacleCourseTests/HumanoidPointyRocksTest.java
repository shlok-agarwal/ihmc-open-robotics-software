...
//      setupSupportViz();
   ...
   private ArrayList<FootstepDataListMessage> createFootstepsWithRandomPredictedContactPointLines(double swingTime, double transferTime)
   {
      ...
      HumanoidMessageTools.packPredictedContactPoints(footstepData, transformFromAnkleFrameToSoleFrame(generateContactPointsForRandomRotatedLineOfContact(random), ankleFrame, soleFrame));
      message.footstepDataList.add().set(footstepData);
         ...
         boolean setPredictedContactPoints)
   {
      ...
      if (setPredictedContactPoints && (contactPointsInAnkleFrame != null))
      {
         ...
         HumanoidMessageTools.packPredictedContactPoints(footstepData, contactPointsInSoleFrame);
      }
      return footstepData;
   }
