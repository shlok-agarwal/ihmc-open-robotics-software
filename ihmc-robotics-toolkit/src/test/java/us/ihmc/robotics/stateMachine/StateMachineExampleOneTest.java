...
public class StateMachineExampleOneTest
{
   ...
   public void testConstructionOfSimpleEventBasedStateMachine()
   {
      ...
      YoVariableRegistry registry = new YoVariableRegistry("registry");
      YoDouble time = new YoDouble("time", registry);
      FinishableStateMachineFactory<ExampleStateName, SimpleExampleState> factory = new FinishableStateMachineFactory<>(ExampleStateName.class);
      ...
      factory.addFinishableState(ExampleStateName.Starting, startingState, ExampleStateName.StateOne);
      factory.addFinishableState(ExampleStateName.StateOne, stateOne, ExampleStateName.StateTwo);
      factory.addFinishableState(ExampleStateName.StateTwo, stateTwo, ExampleStateName.Stopped);
      factory.addState(ExampleStateName.Stopped, stoppedState);
   ...
   private class SimpleExampleState implements FinishableState
   {
