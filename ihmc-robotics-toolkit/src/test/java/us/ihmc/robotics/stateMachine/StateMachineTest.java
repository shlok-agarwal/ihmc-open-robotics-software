...
public class StateMachineTest
{
   ...
   public void testStateTransitions()
   {
      ...
      FinishableStateMachineFactory<States, SimpleState> factory = new FinishableStateMachineFactory<>(States.class);
      ...
      {
         factory.addFinishableState(arrayOfStates[i].getStateEnum(), arrayOfStates[i], arrayOfStates[i + 1].getStateEnum());
      }
   ...
   public class SimpleState implements FinishableState
   {
