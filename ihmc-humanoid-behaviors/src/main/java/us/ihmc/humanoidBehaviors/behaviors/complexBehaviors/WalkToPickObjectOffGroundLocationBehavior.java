...
public class WalkToPickObjectOffGroundLocationBehavior extends StateMachineBehavior<WalkState>
{
   ...
   @Override
   protected WalkState configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<WalkState, BehaviorAction> factory)
   {
      ...
      factory.addFinishableState(WalkState.GET_READY_TO_WALK, rightArmHomeTask, WalkState.WALK);
