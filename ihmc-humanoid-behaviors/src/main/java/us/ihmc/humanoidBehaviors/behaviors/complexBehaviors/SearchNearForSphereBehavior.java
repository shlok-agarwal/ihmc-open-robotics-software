...
public class SearchNearForSphereBehavior extends StateMachineBehavior<SearchNearState>
{
   ...
   @Override
   protected SearchNearState configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<SearchNearState, BehaviorAction> factory)
   {
      // BEND OVER *******************************************
      ...
      factory.addFinishableState(SearchNearState.LOOK_DOWN, lookDown, SearchNearState.ENABLE_LIDAR);
      factory.addFinishableState(SearchNearState.ENABLE_LIDAR, enableLidarTask, SearchNearState.SETUP_LIDAR);
      factory.addFinishableState(SearchNearState.SETUP_LIDAR, setLidarMediumRangeTask, SearchNearState.CLEAR_LIDAR);
      factory.addFinishableState(SearchNearState.CLEAR_LIDAR, clearLidarTask, SearchNearState.SEARCHING);

      if (requireUserValidation)
      {
         factory.addFinishableState(SearchNearState.SEARCHING, findBallTask, SearchNearState.VALIDATING);
