...
public class SearchFarForSphereBehavior extends StateMachineBehavior<SearchFarState>
{
   ...
   @Override
   protected SearchFarState configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<SearchFarState, BehaviorAction> factory)
   {
      //ENABLE LIDAR
      ...
      factory.addFinishableState(SearchFarState.ENABLE_LIDAR, enableLidarTask, SearchFarState.SETUP_LIDAR);
      factory.addFinishableState(SearchFarState.SETUP_LIDAR, setLidarMediumRangeTask, SearchFarState.CLEAR_LIDAR);
      factory.addFinishableState(SearchFarState.CLEAR_LIDAR, clearLidarTask, SearchFarState.SEARCHING_FOR_SPHERE);

      if (requireUserValidation)
      {
         factory.addFinishableState(SearchFarState.SEARCHING_FOR_SPHERE, findBallTask, SearchFarState.VALIDATING);
