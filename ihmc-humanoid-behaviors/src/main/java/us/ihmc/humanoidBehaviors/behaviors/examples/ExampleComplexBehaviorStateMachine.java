...
public class ExampleComplexBehaviorStateMachine extends StateMachineBehavior<ExampleStates>
{
   ...
   @Override
   protected ExampleStates configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<ExampleStates, BehaviorAction> factory)
   {
      ...
      factory.addFinishableState(ExampleStates.SETUP_ROBOT_PARALLEL_STATEMACHINE_EXAMPLE, setupRobot, ExampleStates.RESET_ROBOT_PIPELINE_EXAMPLE);
      factory.addFinishableState(ExampleStates.RESET_ROBOT_PIPELINE_EXAMPLE, resetRobot, ExampleStates.ENABLE_LIDAR);
      factory.addFinishableState(ExampleStates.ENABLE_LIDAR, enableLidar, ExampleStates.GET_LIDAR);
      factory.addFinishableState(ExampleStates.GET_LIDAR, getLidar, ExampleStates.GET_VIDEO);
      factory.addFinishableState(ExampleStates.GET_VIDEO, getVideo, ExampleStates.WHOLEBODY_EXAMPLE);
      factory.addFinishableState(ExampleStates.WHOLEBODY_EXAMPLE, wholeBodyExample, ExampleStates.GET_USER_VALIDATION);
