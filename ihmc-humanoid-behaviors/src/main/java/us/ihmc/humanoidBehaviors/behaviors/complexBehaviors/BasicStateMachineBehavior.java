...
public class BasicStateMachineBehavior extends StateMachineBehavior<BasicStates>
{
   ...
   @Override
   protected BasicStates configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<BasicStates, BehaviorAction> factory)
   {
      ...
      factory.addFinishableState(BasicStates.ENABLE_LIDAR, enableLidarTask, BasicStates.CLEAR_LIDAR);
      factory.addFinishableState(BasicStates.CLEAR_LIDAR, clearLidarTask, BasicStates.WALK_TO_LOCATION_AND_HOME_ARM);
