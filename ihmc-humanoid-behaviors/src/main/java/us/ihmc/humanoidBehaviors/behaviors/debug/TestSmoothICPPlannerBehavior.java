...
public class TestSmoothICPPlannerBehavior extends StateMachineBehavior<TestSmoothICPPlannerBehaviorState>
{
   ...
   @Override
   protected TestSmoothICPPlannerBehaviorState configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<TestSmoothICPPlannerBehaviorState, BehaviorAction> factory)
   {
      ...
      factory.addFinishableState(TestSmoothICPPlannerBehaviorState.SETUP_ROBOT, setup, TestSmoothICPPlannerBehaviorState.CONFIRM_WALK);
      factory.addFinishableState(TestSmoothICPPlannerBehaviorState.CONFIRM_WALK, waitForConfirmation, TestSmoothICPPlannerBehaviorState.WALK_FORWARD);
      factory.addFinishableState(TestSmoothICPPlannerBehaviorState.WALK_FORWARD, walkForward, TestSmoothICPPlannerBehaviorState.DONE);
      factory.addFinishableState(TestSmoothICPPlannerBehaviorState.RESET_ROBOT, resetRobot, TestSmoothICPPlannerBehaviorState.DONE);
