...
public class PickUpBallBehaviorStateMachine extends StateMachineBehavior<PickUpBallBehaviorState> implements CoactiveDataListenerInterface
{
   ...
   @Override
   protected PickUpBallBehaviorState configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<PickUpBallBehaviorState, BehaviorAction> factory)
   {
      ...
      factory.addFinishableState(PickUpBallBehaviorState.SETUP_ROBOT, setup, PickUpBallBehaviorState.SEARCHING_FOR_BALL_FAR);
      factory.addFinishableState(PickUpBallBehaviorState.SEARCHING_FOR_BALL_FAR, searchForBallFar, PickUpBallBehaviorState.WALKING_TO_BALL);
      factory.addFinishableState(PickUpBallBehaviorState.WALKING_TO_BALL, walkToBallTask, PickUpBallBehaviorState.SEARCHING_FOR_BALL_NEAR);
      factory.addFinishableState(PickUpBallBehaviorState.SEARCHING_FOR_BALL_NEAR, searchForBallNear, PickUpBallBehaviorState.PICKING_UP_BALL);
      factory.addFinishableState(PickUpBallBehaviorState.PICKING_UP_BALL, pickUpBall, PickUpBallBehaviorState.PUTTING_BALL_IN_BASKET);
      factory.addFinishableState(PickUpBallBehaviorState.PUTTING_BALL_IN_BASKET, putBallInBucket, PickUpBallBehaviorState.RESET_ROBOT);
