...
public abstract class StateMachineBehavior<E extends Enum<E>> extends AbstractBehavior
{
                               ...
                               CommunicationBridge outgoingCommunicationBridge)
   {
      ...
      FinishableStateMachineFactory<E, BehaviorAction> stateMachineFactory = new FinishableStateMachineFactory<>(keyType);
   ...
   protected abstract E configureStateMachineAndReturnInitialKey(FinishableStateMachineFactory<E, BehaviorAction> factory);
